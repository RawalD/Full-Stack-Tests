    ...
    lists = {
      f0ziqq7gfn: {
        ...
        tasks: [
          ...
          { taskId: "kd3ve56f5fh", taskDescription: "Go See Memes on Reddit & 9gag" },
          { taskId: "ld45g5h4tyf", taskDescription: "Hold On For A Miracle LFC CL win..." },
        ],
      },
      ...
      y0zitt47gfb: {
        ...
        tasks: [
          ...
          { taskId: "b0zi5t4rwhc", taskDescription: "Land the TravSIM job :) <3" },
        ],
      },
    };
    storeLists();
